...
# 简单的 HTTP POST 函数
def http_post(url, data, content_type='application/json'):
...
status_code, body = http_post(register_url, register_data)
...
status_code, body = http_post(login_url, login_data, 'application/x-www-form-urlencoded')
print(f"状态码: {status_code}")
print(f"响应内容: {body}")
